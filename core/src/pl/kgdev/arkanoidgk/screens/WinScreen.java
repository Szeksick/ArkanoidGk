...
public class WinScreen implements Screen {
    ...
    Sound music = Gdx.audio.newSound(Gdx.files.internal("win.mp3"));
    ...
    public WinScreen(ArkanoidGK game, int points, int stars, int endedstage){
        ...
        playButonActive = new Texture("Dalej!-1.png");
        playButtonInacitve= new Texture("Dalej!.png");
        statsButtonActive = new Texture("Statystyki.png");
        statsButtonInactive = new Texture("Statystyki-1.png");
        background = new Texture("custom – 1.png");
        music.loop(10);
//        music.play();
